...
public class AnimTool implements ActionListener {
    ...
    static ParticleData1d DataModule; 
    ...
    public JMenuBar createMenuBar() {
        ...
        menuItem = new JMenuItem("Load 1d Particle Data");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source.getText()=="Load 1d Particle Data") {
            ...
            if (selFile!=null){
                ...
                try{
                    ...
                    while ((strLine = br.readLine()) != null)   {
                    	...
                    	// data in format "LRLRLR","1,2,1,2,1,2","50,20,200,100,50,60"
                    	// parse data into LR_string, v_double_array, pos0_double_array
                    	String sD = null;
                    	double[] adV = null,adP = null;
                    	Pattern pattern = Pattern.compile("\"([LR]+)\",\"([0-9\\.,\\-]+)\",\"([0-9\\.,\\-]+)\"");
                        ...
                        if(matcher.matches()) {
                        	...
                        	adP = convertStringArraytoDoubleArray(matcher.group(3).split(","));
                    	...
                    	if (DataModule.append(sD,adV,adP)) {
